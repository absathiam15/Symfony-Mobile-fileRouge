 ...
 *          "name" = "addTransaction",
 *          "denormalization_context"={"groups"={"TransMontant:write"}}
 *          }
 *     },
 *     itemOperations={
 *"get_admin_user" = {
...
class Transactions
{
    ...
    /**
     * @ORM\Column(type="integer")
     * @Groups({"compt:read", "TransMontant:read"})
     ...
     * @Groups({"compt:read", "trans:read", "TransMontant:read"})
     */
