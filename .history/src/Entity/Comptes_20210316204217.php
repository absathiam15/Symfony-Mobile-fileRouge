...
class Comptes
{
     ...
     * @Groups({"agence:write", "agence:read", "TransMontant:read", "trans:write"})
     */
    public $id;

    /**
     * @ORM\Column(type="string", length=255)
     * @Groups({"trans:read", "trans:write", "compt:read", "comptes:write", "agence:write", "agence:read"})
     */
    public $numComptes;

    /**
     * @ORM\Column(type="integer")
     * @Groups({"compt:read", "comptes:write", "agence:write", "agence:read", "trans:read", "trans:write"})
     */
    public $solde;

    /**
     * @ORM\Column(type="date")
     * @Groups({"compt:read", "comptes:write", "agence:write", "agence:read", "TransMontant:read", "trans:write"})
     */
    public $dateCreation;
