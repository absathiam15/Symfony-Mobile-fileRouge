...
class User implements UserInterface
{
     ...
     * @Groups({"user:write", "user:read", "agence:write", "agence:read"})
     */
    protected $username;
     ...
     * @Groups({"trans:read", "trans:write", "user:read", "user:write", "agence:write", "agence:read"})
     */
    protected $nom;

    /**
     * @ORM\Column(type="string", length=255)
     * @Groups({"trans:read", "trans:write", "user:write", "user:read", "agence:write", "agence:read"})
     */
    protected $prenom;
