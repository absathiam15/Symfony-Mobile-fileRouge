...
{ 
    ...
    public function depotTransaction(Request $request,SerializerInterface $serializer, EntityManagerInterface $entityManager,
       ...
       */
        public function retraitTransaction(TransactionsRepository $transRepo, $codeTransaction, Request $request, EntityManagerInterface $entityManager) {
           // dd('test');
         ...
         //  dd($data);
            $trans = new Transactions();
             ...
             $clientRetrait = $trans->getClients()->getNomComplet
            dd($clientRetrait);
