...
{ 
    ...
    public function depotTransaction(Request $request,SerializerInterface $serializer, EntityManagerInterface $entityManager,
       ...
       * )
       */
        public function retraitTransaction(TransactionsRepository $transRepo, $codeTransaction, TransactionServices $transactionService, EntityManagerInterface $manager Request $request) {
            //dd('test');
