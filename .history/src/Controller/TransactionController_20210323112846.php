...
{ 
    ...
    public function depotTransaction(Request $request,SerializerInterface $serializer, EntityManagerInterface $entityManager,
       ...
       * )
       */
        public function retraitTransaction(TransactionsRepository $transRepo, $codeTransaction, TransactionServices $transactionService, EntityManagerInterface $ma Request $request) {
            //dd('test');
