...
{ 
    ...
    public function depotTransaction(Request $request,SerializerInterface $serializer, EntityManagerInterface $entityManager,
       ...
       * )
       */
        public function retraitTransaction(TransactionsRepository $transRepo, $codeTransaction, TransactionServices $transactionService, EntityManagerInterface $ Request $request) {
            //dd('test');
